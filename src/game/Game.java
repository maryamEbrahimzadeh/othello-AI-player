    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (tmp) {
            ...
            case 1:
                ...
                //player = new players.AI(2);
                //player = new players.RandomPlayer(2);
                player =  new players.Greedy(2);
                player.setBoardMark(X);
                player.setOpponentBoardMark(O);
                player.setGame(game);
                //Define player 2 class
...
//                }
                ...
                //player2 = new players.Greedy(2);
                player2 =  new players.AI(2);
                player2.setBoardMark(O);
                player2.setOpponentBoardMark(X);
                player2.setGame(game);
                break;
...
//           player 1 plays
            ...
            if (moveList.size() > 0) {
                try {
                    ...
                    //System.out.println(boardPlace.getCol() + " "+ boardPlace.getRow());
